...
module.exports = {
	...
	manualAdd: function (req, res) {
		...
		request('https://maps.googleapis.com/maps/api/geocode/json?address=' + req.body.addressObj.road + ','+ req.body.addressObj.city + ',' + req.body.addressObj.state + ',' + req.body.addressObj.zipCode + '&key=' + process.env.GOOGLE_API,
			function (error, response, body) {
				console.log("HELLO")
